...
let g:ct16_1 = 238 " light background (status bar)
let g:ct16_2 = 59  " selection background
let g:ct16_3 = 244 " comments, invisibles
...
let g:ct16_9 = 186 " literals
let g:ct16_A = 150 " classes
let g:ct16_B = 115 " strings
let g:ct16_C = 110 " escapes
let g:ct16_D = 140 " functions
let g:ct16_E = 175 " keywords
let g:ct16_F = 174 " delimiters
